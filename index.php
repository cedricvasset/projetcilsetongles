...
<div class="row">
    <div class="presentation col-lg-5 col-sm-12 align-items-center from-right">
            <div class="col-lg-12 from-right">
                <h2>Cils & Ongles</h2>
                <p>Créé en 2017 par une passionnée Cils & Ongles vous accueil désormais dans un nouvel espace dédié à la beauté de vos mains et de votre regard.</p>
            </div>
            <div class="col-lg-12 ">
                <img class="local img-fluid from-left" src="assets/img/local.jpg">
            </div>
        </div>     
    <div class="promo col-lg-4 col-sm-12 from-right">
