...
class users extends dataBase {
    ...
    {
        $state = false;
        $query = 'SELECT `a7b98_users`.`id`, `a7b98_users`.`firstname`, `a7b98_users`.`lastname`, DATE_FORMAT(`birthdate`, \'%d-%m-%Y\') AS `birthdate`, `a7b98_users`.`mail`, `a7b98_users`.`phone`, `a7b98_users`.`creationDate`, `a7b98_users`.`password`, `a7b98_users`.`cgu`, `a7b98_users`.`id_a7b98_roles` FROM  `a7b98_users` WHERE `mail` = :mail';
    ...
    /**
     * permet de récupérer toutes les données d'un client 
     * @return array
     */
...
//        sinon on returne le tableau vide initialisé 
    ...
    /**
     * compte le nombre de client de la table users
     * @return array
     */
...
//    si ma methode s 'execute corectement et que c est bien un objet je retourne le resultat de ma requete
    ...
    /**
     * recupere les infos clients de la table user utilisation de l'hydratation
     * @return boolean
     */
