        ...
        <div class="identity">
            <div class="row col-lg-12 justify-content-center">
                <div class="col-lg-4">
                    ...
                    <input type="text" class="form-control" placeholder="Nom" id="lastname" name="lastname" value="<?= (isset($lastname)) ? $_POST['lastname'] : '' //pour que le texte saisi reste en memoire donne à la value le contenu du $_POST['lastname']     ?>">
